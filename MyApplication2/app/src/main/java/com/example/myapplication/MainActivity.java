...
public class MainActivity extends AppCompatActivity implements Player.EventListener{
    ...
    public static Intent getStartIntent(Context context, String videoUri) {
        ...
        intent.putExtra(VideoPlayConfig.DEFAULT_VIDEO_URL, videoUri);
        return intent;
    }
    @Override
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            LoadControl loadControl = new DefaultLoadControl(
                    ...
                    VideoPlayConfig.MIN_BUFFER_DURATION,
                    VideoPlayConfig.MAX_BUFFER_DURATION,
                    VideoPlayConfig.MIN_PLAYBACK_START_BUFFER,
                    VideoPlayConfig.MIN_PLAYBACK_RESUME_BUFFER, -1, true);
