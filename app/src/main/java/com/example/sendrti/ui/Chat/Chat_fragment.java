...
public class Chat_fragment extends Fragment implements View.OnClickListener {
    ...
    private static final String LOG_TAG = Chat_fragment.class.getSimpleName();
...
//    public static Chat_fragment newInstance(@NonNull String channelUrl) {
...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.chat_fragment_fragment, container, false);

        mRootLayout = view.findViewById(R.id.layout_open_chat_root);

        mRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_open_channel_chat);

        mCurrentEventLayout = view.findViewById(R.id.layout_open_chat_current_event);
        mCurrentEventText = (TextView) view.findViewById(R.id.text_open_chat_current_event);

        mMessageSendButton = (Button) view.findViewById(R.id.button_open_channel_chat_send);
        mMessageEditText = (EditText) view.findViewById(R.id.edittext_chat_message);

        PrefrenceUtil.init(getContext());
        ...
        //   getview(view);
       // studentAdapter = new ChatAdapter2(studentData,getActivity());
...
//        recyclerView.setAdapter(studentAdapter);
       ...
       // Studentdateilsmodel();
        ...
        mUploadFileButton = (ImageButton) view.findViewById(R.id.button_open_channel_chat_upload);
      ...
      // mChannelUrl = getArguments().getString(EXTRA_OPEN_CHANNEL_URL);
...
//    }
    ...
    private void Reciver() {
        ...
        ChatModel data = new ChatModel(ChatModel.RECEIVERTYPE,"Hi");
        studentData.add(data);
        data = new ChatModel(ChatModel.RECEIVERTYPE,"Hi swati");
        studentData.add(data);
//        ImageModel imageModel = new ImageModel(ChatModel.RECEIVERIMAGE,R.drawable.ic_attach_file_black_24dp);
//        data = new ChatModel(imageModel);
//        studentData.add(data);
...
//
//        send = View.findViewById(R.id.sendedit);
//        sendbtn = View.findViewById(R.id.icon);
//        recyclerView = View.findViewById(R.id.recyclerview2);
//
//    }


//    private void Studentdateilsmodel() {
//        ChatModel data = new ChatModel("sai");
//        studentDataList.add(data);
//        data = new ChatModel("sai raj");
//        studentDataList.add(data);
//    }
...
//                        if (!(s.equals("")))
//                        {
//                            ChatModel  data = new ChatModel(ChatModel.SENDERTYPE,s);
//                            studentData.add(studentData.size(), data);
//                            studentAdapter.notifyDataSetChanged();
//                          //  Toast.makeText(getContext(), String.valueOf(.size()), Toast.LENGTH_LONG).show();
//                        }
//                        else
//                        {
//                            Toast.makeText(getContext(),"Enter any the problem",Toast.LENGTH_LONG).show();
//                        }
//
//                    }
//
