...
public class OpenChatFragment extends Fragment {
    ...
    public OpenChatFragment(OpenChannel channel) {
        mChannel =channel;
    }
    ...
    public static OpenChatFragment newInstance(@NonNull String channelUrl) {
        ...
        Log.d("channnelUrlDp",channelUrl);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     //   Log.d("ChannelUrl",mChannelUrl);

      //  Log.d("mChannel",mChannel.getName());
        mRootLayout = rootView.findViewById(R.id.layout_open_chat_root);
        //Log.d("ChannelUrl",mChannel.getName());
            ...
            public void onResult(final OpenChannel openChannel, SendBirdException e) {
                ...
                openChannel.enter(new OpenChannel.OpenChannelEnterHandler() {
                    ...
                    public void onResult(SendBirdException e) {
                      ...
                      //  Log.d("name2",mChannel.getName());
//
                        if (getActivity() != null) {
                            // Set action bar title to name of channel
                         getActivity().getActionBar().setTitle(mChannel.getName());
                        }
